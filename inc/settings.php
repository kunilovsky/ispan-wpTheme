...
$args = array(
	...
	'menu_title'                => esc_html__('Site setting', 'your-textdomain-here'),

	// The text to appear on the page title.
	'page_title'                => esc_html__('Site setting', 'your-textdomain-here'),
...
if (!isset($args['global_variable']) || false !== $args['global_variable']) {
	...
	$args['intro_text'] = '<p>' . sprintf(esc_html__('Hello!'), '<strong>' . $v . '</strong>') . '<p>';
} else {
	$args['intro_text'] = '<p>' . esc_html__('Hi!') . '</p>';
}

// Add content after the form.
$args['footer_text'] = '<p>' . esc_html__('Hi!') . '</p>';
